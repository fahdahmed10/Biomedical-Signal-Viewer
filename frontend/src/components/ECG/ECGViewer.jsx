      ...
      <div className="controls-panel">
        ...
        {allChannels.length > 0 && (
          <>
            <button
              ...
              onClick={() => setVisibleChannels([...allChannels])}
            >
              Select All
            </button>
        ...
        {showCombinationUI && (
          <div className="combination-box">
            <p style={{ color: "#00c6ff", marginBottom: "10px", fontSize: "0.9rem" }}>
            ...
            >
              Average Selected ({selectedForCombination.length} channels)
            </button>
          </div>
        )}
        ...
        <button
          className={`ecg-btn ${
            isPlaying ? "ecg-btn-danger" : "ecg-btn-success"
          }`}
        ...
        <label>Speed: {speedOption}x</label>
        <input
          type="range"
          min="0.5"
          max="4"
